...
class CometEpochCallback(EpochCallback):
    def __init__(self, project_name: str):
        ...
        self._experiment: Optional[comet_ml.Experiment] = None

    def __call__(
        self, trainer: Trainer, metrics: Dict[str, Any], epoch: int, is_master: bool
    ):
        if epoch == -1:
            ...
            if self._experiment is None:
                raise ValueError("Experiment should not set after the first epoch")
